  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormState((prev) => ({
        ...
        loading: false,
        errors: {
          submit: error.response?.data?.message || "Login failed. Please check your details.",
        },
      }));
    }
  };
    ...
    return (
      <div className="min-h-screen flex items-center justify center bg-gray-50 px-4">
        ...
        >
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Welcoome Back!</h2>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Email Field - Now correctly isolated */}
          <div>
          ...
          {/* Password Field - Now correctly isolated */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Password
            </label>
