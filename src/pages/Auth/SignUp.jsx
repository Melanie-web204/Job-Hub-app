              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-lg border ${
                  formState.errors.fullName
                    ? "border-red-500"
                    : "border-gray-300"
                } focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-transparent transition-colors`}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                } focus:ring-1 focus:ring-blue-500 focus:border-transparent transition-colors`}
