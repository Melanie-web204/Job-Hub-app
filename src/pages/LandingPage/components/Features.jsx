        ...
        <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                    ...
                    JobHub offers a comprehensive suite of features designed to
                    ...
                    <div className="text-center mb-12">
                        ...
                        <div className="space-y-8">
                            {jobSeekerFeatures.map((feature, index) => (
                                <div key={index} 
                                className="group flex items-start space-x-4 p-6 rounded-2xl hover:bg-blue-50 transition-colors duration-300 cursor-pointer">

                                    <div className="shrink-0 w-12 h-12 bg-blue-100 rounded-2xl flex items-center justify-center group-hover:bg-blue-200 transition-colors">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <div className="space-y-8">
                            {employerFeatures.map((feature, index) => (
                                <div key={index} 
                                className="group flex items-start space-x-4 p-6 rounded-2xl hover:bg-purple-50 transition-colors duration-300 cursor-pointer">
